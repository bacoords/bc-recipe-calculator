...
namespace BCRecipeCalculator\CPTS;
...
class BCRecipeCalculator {
	...
	public function enqueue_admin_scripts( $hook ) {
		...
		if ( 'toplevel_page_recipes-dashboard' === $hook ) {
			$asset_file = BC_RECIPE_CALCULATOR_DIR . 'build/index.asset.php';
			...
			if ( file_exists( $asset_file ) ) {
				...
				wp_enqueue_script(
					...
					BC_RECIPE_CALCULATOR_URL . 'build/index.js',
				...
				wp_enqueue_style(
					'bc-recipe-calculator-admin',
					BC_RECIPE_CALCULATOR_URL . 'build/style-index.css',
					array(),
					$asset_data['version']
				);
